...
#if !defined( _MSIECFTOOLS_GETOPT_H )
#define _MSIECFTOOLS_GETOPT_H
...
typedef struct msiecftools_option msiecftools_option_t;

struct msiecftools_option
{
...
#define msiecftools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t msiecftools_getopt(
                  int argument_count,
...
void msiecftools_getopt_wrapped_fprint(
      FILE *stream,
...
void msiecftools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const msiecftools_option_t *options,
      int number_of_options );

int msiecftools_getopt_get_options_string(
     const msiecftools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _MSIECFTOOLS_GETOPT_H ) */
