...
void (*msiecftools_signal_signal_handler)( msiecftools_signal_t ) = NULL;
             ...
             unsigned long signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( msiecftools_signal_signal_handler != NULL )
			{
				msiecftools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
...
{
	static char *function = "msiecftools_signal_attach";
...
#if defined( _MSC_VER )
	msiecftools_signal_initialize_memory_debug();
#endif
     ...
     libcerror_error_t **error )
{
	...
	msiecftools_signal_signal_handler = NULL;
