...
#if !defined( _LIBMSIECF_LIBCTHREADS_H )
#define _LIBMSIECF_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBMSIECF )
#define HAVE_LIBMSIECF_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBMSIECF_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBMSIECF_LIBCTHREADS_H ) */
