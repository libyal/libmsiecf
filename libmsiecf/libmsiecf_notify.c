...
{
	static char *function = "libmsiecf_notify_set_stream";
...
int libmsiecf_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libmsiecf_notify_stream_open";
...
int libmsiecf_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libmsiecf_notify_stream_close";
