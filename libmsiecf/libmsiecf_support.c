...
#include "libmsiecf_libclocale.h"
#include "libmsiecf_libcerror.h"
#include "libmsiecf_support.h"
...
const char *libmsiecf_get_version(
             void )
{
	return( (const char *) LIBMSIECF_VERSION_STRING );
}
...
int libmsiecf_get_access_flags_read(
     void )
{
	return( (int) LIBMSIECF_ACCESS_FLAG_READ );
}
...
{
	static char *function = "libmsiecf_get_codepage";
...
int libmsiecf_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libmsiecf_set_codepage";
...
/* Determines if a file is a PPF file (check for the MSIECF file signature)
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libmsiecf_check_file_signature";
...
/* Determines if a file is a MSIECF file (check for the MSIECF file signature)
 * Returns 1 if true, 0 if not or -1 on error
 */
...
{
	libbfio_handle_t *file_io_handle = NULL;
	static char *function            = "libmsiecf_check_file_signature_wide";
	size_t filename_length           = 0;
	int result                       = 0;
...
/* Determines if a file is a MSIECF file (check for the MSIECF file signature) using a Basic File IO (bfio) handle
 * Returns 1 if true, 0 if not or -1 on error
 */
     ...
     libcerror_error_t **error )
{
	...
	static char *function      = "libmsiecf_check_file_signature_file_io_handle";
