 ...
 */
int pymsiecf_file_object_io_handle_free(
     pymsiecf_file_object_io_handle_t **file_object_io_handle,
     libcerror_error_t **error )
{
	static char *function      = "pymsiecf_file_object_io_handle_free";
 ...
 * Returns 1 if succesful or -1 on error
 */
int pymsiecf_file_object_io_handle_clone(
     pymsiecf_file_object_io_handle_t **destination_file_object_io_handle,
     pymsiecf_file_object_io_handle_t *source_file_object_io_handle,
     libcerror_error_t **error )
{
	static char *function = "pymsiecf_file_object_io_handle_clone";
 ...
 * Returns 1 if successful or -1 on error
 */
int pymsiecf_file_object_io_handle_open(
     pymsiecf_file_object_io_handle_t *file_object_io_handle,
     int access_flags,
     libcerror_error_t **error )
{
	static char *function = "pymsiecf_file_object_io_handle_open";
 ...
 */
int pymsiecf_file_object_io_handle_close(
     pymsiecf_file_object_io_handle_t *file_object_io_handle,
     libcerror_error_t **error )
{
	static char *function = "pymsiecf_file_object_io_handle_close";
 ...
 * Returns the number of bytes read if successful, or -1 on error
 */
ssize_t pymsiecf_file_object_io_handle_read(
         pymsiecf_file_object_io_handle_t *file_object_io_handle,
         uint8_t *buffer,
         size_t size,
         libcerror_error_t **error )
{
	static char *function      = "pymsiecf_file_object_io_handle_read";
	PyGILState_STATE gil_state = 0;
	ssize_t read_count         = 0;
	...
	read_count = pymsiecf_file_object_read_buffer(
	              file_object_io_handle->file_object,
	              buffer,
	              size,
	              error );
 ...
 */
ssize_t pymsiecf_file_object_write_buffer(
         PyObject *file_object,
         ...
         libcerror_error_t **error )
{
	...
	PyObject *method_name     = NULL;
	PyObject *method_result   = NULL;
	static char *function     = "pymsiecf_file_object_write_buffer";
 ...
 * Returns the number of bytes written if successful, or -1 on error
 */
ssize_t pymsiecf_file_object_io_handle_write(
         pymsiecf_file_object_io_handle_t *file_object_io_handle,
         const uint8_t *buffer,
         size_t size,
         libcerror_error_t **error )
{
	static char *function      = "pymsiecf_file_object_io_handle_write";
	PyGILState_STATE gil_state = 0;
	...
	write_count = pymsiecf_file_object_write_buffer(
	               file_object_io_handle->file_object,
	               buffer,
	               size,
	               error );
 ...
 * Returns 1 if successful or -1 on error
 */
int pymsiecf_file_object_seek_offset(
     PyObject *file_object,
     off64_t offset,
     int whence,
     libcerror_error_t **error )
{
	...
	PyObject *method_name     = NULL;
	PyObject *method_result   = NULL;
	static char *function     = "pymsiecf_file_object_seek_offset";
 ...
 * Returns 1 if successful or -1 on error
 */
int pymsiecf_file_object_get_offset(
     PyObject *file_object,
     off64_t *offset,
     libcerror_error_t **error )
{
	PyObject *method_name   = NULL;
	PyObject *method_result = NULL;
	static char *function   = "pymsiecf_file_object_get_offset";
	int result              = 0;
	...
	if( pymsiecf_integer_signed_copy_to_64bit(
	     method_result,
	     offset,
	     error ) != 1 )
	{
 ...
 */
off64_t pymsiecf_file_object_io_handle_seek_offset(
         pymsiecf_file_object_io_handle_t *file_object_io_handle,
         off64_t offset,
         int whence,
         libcerror_error_t **error )
{
	static char *function      = "pymsiecf_file_object_io_handle_seek_offset";
	PyGILState_STATE gil_state = 0;
	...
	if( pymsiecf_file_object_seek_offset(
	     file_object_io_handle->file_object,
	     offset,
	     whence,
	     error ) != 1 )
	...
	if( pymsiecf_file_object_get_offset(
	     file_object_io_handle->file_object,
	     &offset,
	     error ) != 1 )
	{
 ...
 */
int pymsiecf_file_object_io_handle_exists(
     pymsiecf_file_object_io_handle_t *file_object_io_handle,
     libcerror_error_t **error )
{
	static char *function = "pymsiecf_file_object_io_handle_exists";
 ...
 */
int pymsiecf_file_object_io_handle_is_open(
     pymsiecf_file_object_io_handle_t *file_object_io_handle,
     libcerror_error_t **error )
{
	static char *function = "pymsiecf_file_object_io_handle_is_open";
 ...
 * Returns 1 if successful or -1 on error
 */
int pymsiecf_file_object_get_size(
     PyObject *file_object,
     size64_t *size,
     libcerror_error_t **error )
{
	PyObject *method_name   = NULL;
	PyObject *method_result = NULL;
	static char *function   = "pymsiecf_file_object_get_size";
	...
	if( pymsiecf_integer_unsigned_copy_to_64bit(
	     method_result,
	     size,
	     error ) != 1 )
	{
 ...
 * Returns 1 if successful or -1 on error
 */
int pymsiecf_file_object_io_handle_get_size(
     pymsiecf_file_object_io_handle_t *file_object_io_handle,
     size64_t *size,
     libcerror_error_t **error )
{
	PyObject *method_name      = NULL;
	static char *function      = "pymsiecf_file_object_io_handle_get_size";
	PyGILState_STATE gil_state = 0;
	...
	if( result != 0 )
	{
		if( pymsiecf_file_object_get_size(
		     file_object_io_handle->file_object,
		     size,
		     error ) != 1 )
		{
	...
	else
	{
		     ...
		     error ) != 1 )
		{
			...
			pymsiecf_file_object_seek_offset(
			 file_object_io_handle->file_object,
			 current_offset,
			 SEEK_SET,
			 NULL );
