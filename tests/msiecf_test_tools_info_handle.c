...
#include "../msiecftools/info_handle.h"

/* Tests the info_handle_initialize function
 * Returns 1 if successful or 0 if not
 */
int msiecf_test_tools_info_handle_initialize(
     void )
{
 ...
 * Returns 1 if successful or 0 if not
 */
int msiecf_test_tools_info_handle_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	MSIECF_TEST_RUN(
	 ...
	 msiecf_test_tools_info_handle_initialize );

	MSIECF_TEST_RUN(
	 "info_handle_free",
	 msiecf_test_tools_info_handle_free );
