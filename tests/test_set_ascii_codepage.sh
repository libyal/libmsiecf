...
MSIECF_TEST_SET_ASCII_CODEPAGE="msiecf_test_set_ascii_codepage";

if ! test -x ${MSIECF_TEST_SET_ASCII_CODEPAGE};
then
	MSIECF_TEST_SET_ASCII_CODEPAGE="msiecf_test_set_ascii_codepage.exe";
fi

if ! test -x ${MSIECF_TEST_SET_ASCII_CODEPAGE};
then
	echo "Missing executable: ${MSIECF_TEST_SET_ASCII_CODEPAGE}";
...
do
	...
	${TEST_RUNNER} ./${MSIECF_TEST_SET_ASCII_CODEPAGE} ${CODEPAGE};
