...
#if !defined( _MSIECF_TEST_GETOPT_H )
#define _MSIECF_TEST_GETOPT_H
...
#define msiecf_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t msiecf_test_getopt(
                  int argument_count,
...
#endif /* !defined( _MSIECF_TEST_GETOPT_H ) */
