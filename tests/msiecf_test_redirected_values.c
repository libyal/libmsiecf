/*
 * Library redirected_values type testing program
 *
...
/* Tests the libmsiecf_redirected_values_initialize function
 * Returns 1 if successful or 0 if not
 */
int msiecf_test_redirected_values_initialize(
     void )
{
	...
	redirected_values = (libmsiecf_redirected_values_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libmsiecf_redirected_values_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libmsiecf_redirected_values_initialize with memset failing
		 */
...
/* Tests the libmsiecf_redirected_values_free function
 * Returns 1 if successful or 0 if not
 */
int msiecf_test_redirected_values_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	MSIECF_TEST_RUN(
	 "libmsiecf_redirected_values_initialize",
	 msiecf_test_redirected_values_initialize );
