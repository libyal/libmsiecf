...
LIBRARY_TESTS="directory_descriptor error io_handle item item_descriptor leak_values notify property_type redirected_values url_values";
...
run_test_with_input()
{
	...
	run_test_on_input_directory "libmsiecf" "${TEST_DESCRIPTION}" "default" "${OPTION_SETS}" "${TEST_EXECUTABLE}" "input" "${INPUT_GLOB}";
	local RESULT=$?;
