 ...
 */
int msiecf_test_directory_descriptor_initialize(
     void )
{
	...
	directory_descriptor = (libmsiecf_directory_descriptor_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libmsiecf_directory_descriptor_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libmsiecf_directory_descriptor_initialize with memset failing
		 */
...
/* Tests the libmsiecf_directory_descriptor_free function
 * Returns 1 if successful or 0 if not
 */
int msiecf_test_directory_descriptor_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	MSIECF_TEST_RUN(
	 "libmsiecf_directory_descriptor_initialize",
	 msiecf_test_directory_descriptor_initialize );
