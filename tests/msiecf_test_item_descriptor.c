/*
 * Library item_descriptor type testing program
 *
 ...
 */
int msiecf_test_item_descriptor_initialize(
     void )
{
	...
	/* Test regular cases
	 */
	result = libmsiecf_item_descriptor_initialize(
	          &item_descriptor,
	          &error );
	...
	result = libmsiecf_item_descriptor_free(
	          &item_descriptor,
	          &error );
	...
	item_descriptor = (libmsiecf_item_descriptor_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libmsiecf_item_descriptor_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libmsiecf_item_descriptor_initialize with memset failing
		 */
...
/* Tests the libmsiecf_item_descriptor_free function
 * Returns 1 if successful or 0 if not
 */
int msiecf_test_item_descriptor_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	MSIECF_TEST_RUN(
	 ...
	 msiecf_test_item_descriptor_initialize );
